#ifndef CASPARDEVICE_H
#define CASPARDEVICE_H
...
class CASPARSHARED_EXPORT CasparDevice : public AmcpDevice
{
    Q_OBJECT

    public:
        explicit CasparDevice(const QString& address, int port = 5250, QObject* parent = nullptr);
