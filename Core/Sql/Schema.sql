...
CREATE TABLE Playlist (Id INTEGER PRIMARY KEY AUTO_INCREMENT, Name TEXT, DeviceId INTEGER, TypeId INTEGER, ThumbnailId INTEGER, Timecode TEXT, Fps INTEGER);
CREATE TABLE Scares (Id INTEGER PRIMARY KEY AUTO_INCREMENT, Name TEXT, DeviceId INTEGER, TypeId INTEGER, ThumbnailId INTEGER, Timecode TEXT, Fps INTEGER);
CREATE TABLE Extras (Id INTEGER PRIMARY KEY AUTO_INCREMENT, Name TEXT, DeviceId INTEGER, TypeId INTEGER, ThumbnailId INTEGER, Timecode TEXT, Fps INTEGER);
